...
import {ResponseTaskEntityType, TaskPriorities, tasksAPI, TaskStatuses} from "../api/Todolists.api";
...
export const setTasksAC = (todolistID: string, tasks: Array<ResponseTaskEntityType>) => {
    return {
